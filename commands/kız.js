...
module.exports = {
    ...
    run: async (client, message, args) => {
        if (!args[0]) return message.reply(`${client.emojis.cache.find(x => x.name === "1013946680296616006")} Komutu yanlış kullandınız. .k <@Kira/ID> <İsim> <Yaş>`).then(msg => { setTimeout(() => { msg.delete() }, 10000); });
        ...
        if (!member) return message.reply(`${client.emojis.cache.find(x => x.name === "1013946680296616006")} Komutu yanlış kullandınız. .k <@Kira/ID> <İsim> <Yaş>`).then(msg => { setTimeout(() => { msg.delete() }, 10000); });
        if (!name) return message.reply(`${client.emojis.cache.find(x => x.name === "1013946680296616006")} Komutu yanlış kullandınız. .k <@Kira/ID> <İsim> <Yaş>`).then(msg => { setTimeout(() => { msg.delete() }, 10000); });
        if (!age) return message.reply(`${client.emojis.cache.find(x => x.name === "1013946680296616006")} Komutu yanlış kullandınız. .k <@Kira/ID> <İsim> <Yaş>`).then(msg => { setTimeout(() => { msg.delete() }, 10000); });
        if (isNaN(age)) return message.reply(`${client.emojis.cache.find(x => x.name === "1013946680296616006")} Komutu yanlış kullandınız. .k <@Kira/ID> <İsim> <Yaş>`).then(msg => { setTimeout(() => { msg.delete() }, 10000); });
